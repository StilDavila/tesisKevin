...
//Funciones de Pertenencia de las etiquetas linguisticas
    ...
    $ActividadFisica3 = new PertenenciaTrapezoidal(3,7,4,7);
    ...
    $Riesgo4 = new PertenenciaTrapezoidal(0.49,1,0.65,1);
    ...
    $alimentacionTotal = round($_POST['alimentacion'],2);
    $geneticaTotal = round($_POST['genetica'],2);
    $glucosaTotal = $_POST['glucosa'];
    $actividadFisicaTotal = round($_POST['actividadFisica'],2);

    // echo 'Alimentacion:'.$alimentacionTotal;
    // echo 'Genetica: '.$geneticaTotal;
    // echo 'Glucosa: '.$glucosaTotal;
    // echo 'ActividadFisica: '.$actividadFisicaTotal;


    // Fuzzificar
    $Alimentacion->fuzificar($alimentacionTotal);
    $Glucosa->fuzificar($glucosaTotal);
    $Genetica->fuzificar($geneticaTotal);
    $ActividadFisica->fuzificar($actividadFisicaTotal);
    
    // Fuzzificar
    // $Alimentacion->fuzificar(1);
    // $Glucosa->fuzificar(90);
    // $Genetica->fuzificar(5);
    // $ActividadFisica->fuzificar(1.8);

    // echo $Alimentacion;
    // echo 'Glucosa: '.$Glucosa;
    // echo 'Genetica: '.$Genetica;
    // echo 'ActividadF: '.$ActividadFisica;
