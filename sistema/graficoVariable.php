                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="graficoVariable.php">Gráfico variables</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">LISTA DE VARIABLES</h4>
                                        ...
                                        <table class="table table-hover text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <hr>
                                                    ...
                                                    <div id="variable_output" hidden></div>
                                                <hr hidden>
                                                    <!-- <h1>Inferences:</h1> -->
                                                    <div id="inferences" hidden></div>
                                                <hr hidden>
                                                    <!-- <h1>Input:</h1> -->
        ...
        var obj = {
            ...
            variables_input: [
                ...
                },
                {
                    ...
                    setsName: ["Normal", "Preocupante", "Muy preocupante"],
                    sets: [
                        [0,0,0,90],
                        [85, 105, 105, 126],
                        [110, 160, 200, 200]
            ...
            variable_output: {
                name: "Riesgo",
                setsName: ["Bajo", "Normal", "Alto", "Critico"],
                sets: [
                    [0,0,0,0.1],
                    [0.05,0.15,0.15,0.3],
                    [0.2,0.5,0.5,0.6],
